...
public class ReaderDAO {
    ...
    public ObservableList<Reader> findAll() {
        ...
        try(PreparedStatement stmt = this.conn.prepareStatement(sql))
        {
            ...
            while (resultSet.next())
            {
                ...
                Reader reader = new Reader(firsName, lastName, email, city,id);
                readers.add(reader);
            }
    ...
    public void update(Object entity) {
        ...
        String sql = "UPDATE Reader SET Name = ?, LastName = ?, Email = ?, City = ? WHERE id = ?";
        ...
        try(PreparedStatement stmt = this.conn.prepareStatement(sql)){
            ...
            stmt.setInt(5, reader.getUserId());
            ...
            if(rowsUpdated > 0){
                ...
                logger.warning("No author found with id: " + reader.getUserId());
            }
        }catch (SQLException e){
