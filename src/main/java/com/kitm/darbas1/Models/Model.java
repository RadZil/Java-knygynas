...
public class Model {
    ...
    public final BookAccountingDAO bookAccountingDAO;
    ...
    private Model()
    {
        ...
        this.bookAccountingDAO = new BookAccountingDAO(new DatabaseDriver().getConnection());
    }
    ...
    * */
    ...
    public void createReader(String name,String lastname,String email,String city){
        readerDAO.create(name,lastname,email,city);
    }

    public void setTaken(int id, String status){
        booksDAO.setTaken(id, status);
    }

    public ObservableList<BookAccounted> findAllAccounted(){
        return bookAccountingDAO.findAll();
    }
