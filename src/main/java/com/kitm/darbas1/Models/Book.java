...
public class Book {
    ...
    public Book(int id, String ISBN, String name, String category, String description, int pageNumber, String releaseDate, int price, int authorID, String Taken) {
